...
import { setRestaurant } from "../slices/restarauntSlice";
      ...
      <ScrollView>
        <View className="relative">
          ...
          <TouchableOpacity
            ...
            className="absolute top-14 left-5 p-1 bg-gray-50 rounded-full shadow"
          >
            <AntDesign
              name="arrowleft"
              size={26}
        ...
        >
          <View className="px-5">
            ...
            <Text className="text-gray-500 mt-2">{item.address}</Text>
          </View>
        </View>
