...
export default function Cancelled() {
  ...
  return (
    ...
    />
      ...
      <Text  className={"text-center p-4 "} >But don't sleep with empty stomach, eat something .You can order something else because we  deliver your favourite food.  </Text>
